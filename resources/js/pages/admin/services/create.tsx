...
import { services_index, services_store } from '@/routes';
...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Послуги', href: services_index().url },
    { title: 'Створити послугу', href: '#' },
];

export default function CreateService({ masters }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Створити послугу" />

            <div className="p-6">
                <div className="mx-auto max-w-2xl rounded-xl border bg-white p-6">
                    <Form action={services_store().url} method="POST" className="space-y-5">
                        {/* Title */}
                        <div>
                        ...
                        <div>
                            <label htmlFor="image" className="block text-sm font-medium text-gray-700">
                                Фото послуги
                                <span className="ml-1 text-xs font-normal text-gray-400">(необов'язково, до 2 МБ)</span>
                            </label>
                            <input
                                type="file"
                                id="image"
